...
<div class="ace-wizard-step ace-step-first-article">
	<h2><?php esc_html_e( 'Let\'s Create Your First Article!', 'ai-content-engine' ); ?></h2>
	<p class="step-description">
		<?php esc_html_e( 'Enter a topic and watch the magic happen. We\'ll create a draft article for you to review.', 'ai-content-engine' ); ?>
	</p>

	<form id="first-article-form" class="wizard-form">
		<div class="form-row">
			<label for="article-topic">
				<strong><?php esc_html_e( 'Article Topic', 'ai-content-engine' ); ?></strong>
			...
			<input 
				...
				name="topic" 
				class="large-text" 
				placeholder="<?php esc_attr_e( 'e.g., How to improve team productivity with AI tools', 'ai-content-engine' ); ?>"
				required
			>
			<p class="description">
				<?php esc_html_e( 'Tip: Be specific! Better topics lead to better articles.', 'ai-content-engine' ); ?>
			</p>
		</div>
		...
		<div id="generation-progress" class="generation-progress" style="display: none;">
			...
			<div class="progress-steps">
				<div class="progress-step active" data-step="1">
					...
					<?php esc_html_e( 'Building prompt...', 'ai-content-engine' ); ?>
				</div>
				<div class="progress-step" data-step="2">
					<span class="dashicons dashicons-update"></span>
					<?php esc_html_e( 'Generating content...', 'ai-content-engine' ); ?>
				</div>
		...
		<div id="article-preview" class="article-preview" style="display: none;">
			<h3><?php esc_html_e( 'Preview', 'ai-content-engine' ); ?></h3>
			...
			<div class="preview-actions">
				<a href="#" id="edit-article-link" class="button button-secondary" target="_blank">
					...
					<?php esc_html_e( 'Edit Draft', 'ai-content-engine' ); ?>
				</a>
				<button type="button" id="regenerate-btn" class="button">
					<span class="dashicons dashicons-image-rotate"></span>
					<?php esc_html_e( 'Try Different Topic', 'ai-content-engine' ); ?>
				</button>
			</div>
		</div>
	</form>
